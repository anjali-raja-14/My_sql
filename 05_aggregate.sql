...
select count(name) from apna_student;
select max(marks) from apna_student;
select min(grade) from apna_student;
select sum(marks) from apna_student;
select avg(marks) from apna_student;
